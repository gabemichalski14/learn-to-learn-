...
export const CURRICULUM: LevelCurriculum[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { n: 6, title: 'Spelling: c or k to Start', skills: ['spell', 'read'], note: 'Choosing c vs k at the start of a word, based on the vowel that follows.' },
      { n: 7, title: 'Spelling: -ck or -k Ending', skills: ['spell', 'read'], note: 'When to use -ck vs -k after a short vowel.' },
      { n: 8, title: 'Spelling: ING INK Units', skills: ['spell', 'read'], note: 'Glued units: ing, ink, ang, ung, etc.' },
      { n: 9, title: 'Spelling: -tch or -ch Ending', skills: ['spell', 'read'], note: 'When to use -tch vs -ch after a short vowel.' },
